...
from .views import ProfileView, PublicProfileView, MyProjectsView, MyDonationsView, PublicProjectsView
...
urlpatterns = [
    ...
    path('<int:id>/projects/', PublicProjectsView.as_view(), name='public-projects'),
]
